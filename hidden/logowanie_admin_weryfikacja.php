...
<?php
    ...
    if(!isset($_POST["Konto"]) || (trim($_POST["Konto"]) == "") || !isset($_POST["Haslo"]) || (trim($_POST["Haslo"]) == "")){
        ...
        die("<p><a href='logowanie_admin_formularz.php' class='bck'>Powrót do fromularza logowania</a></p>");
    }else{
        ...
        if(isset($polaczenie) && $polaczenie != null){
            try{
            $sql = "EXECUTE dbo.Administrator_Wyswietl '$KontoForm';";
            ...
            if($komenda_sql->rowCount() != 1){
                ...
                if(password_verify($HasloForm, $Haslo) == true){
                    ...
                    print("<p><br><a class='btn' href='powitanie_admin.php'>Przejdź do panelu administratora</a></p>");
                    print("<p><br><a class='bck' href='logowanie_admin_koniec.php'>Wyloguj</a></p>");
                }else{
                    $_SESSION["zalogowany"] = false;
