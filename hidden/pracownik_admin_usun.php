...
<?php
    ...
    if(!isset($_GET["IdPracownik"]) || (trim($_GET["IdPracownik"]) == "") || !is_numeric($_GET["IdPracownik"])){
        ...
        print("<p><a href='pracownik_admin_usun_potw.php?IdPracownik=$IdPracownik' class='btn del'>Tak, usuń</a>
        <a href='pracownik_admin_tabela.php' class='bck'>Nie, wróć do wykazu</a></p>");
    }
}
?>
</div>
